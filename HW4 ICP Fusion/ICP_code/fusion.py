...
class Map:
    ...
    def filter_pass2(self, points, normals, input_points, input_normals,
        ...
        distance_mask = np.linalg.norm((input_points - points) * input_normals, axis=1) < dist_diff
        ...
        cosine_angle = np.sum(unit_normals*unit_input_normals,axis=1)  
        angle_mask = np.arccos(cosine_angle) < angle_diff
